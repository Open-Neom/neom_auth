...
class AuthEnTranslations {
  ...
  static const Map<String, String> values = {
    ...
    AuthTranslationConstants.passwordResetInstruction: 'Enter your email to receive instructions on how to reset your password',
    ...
    AuthTranslationConstants.youWillFindMsg: 'Here you will find users interested in meditation for an activity or for the occasion.',
  };
